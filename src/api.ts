...
const api = {
  ...
  weather: {
    ...
    //   }
       ...
       const request = await fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=${city.latitude}&lon=${city.longitude}&appid=beb9c0f2fc0ece4e746ac3dcaee5b36a&mode=json`)
